from data import create_spam_dataset, vectorize_text, split_data
from model import SimpleMultinomialNaiveBayes
import numpy as np

def main():
    """
    Main function to run the Multinomial Naive Bayes example for text classification.
    """
    ...
    model = SimpleMultinomialNaiveBayes()
